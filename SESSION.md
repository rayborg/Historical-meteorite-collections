...
- Schema 6 contains 2,304 facts-only records across 8 catalogs.
...
- Metadata covers 164 catalog-scoped source pages; records cite 147 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 392 records; its metadata source pages span 26-41, and its record citations span 26-41.
...
- Reviewed MetBull harmonization covers 2,304 of 2,304 records: 2,211 resolved and 93 explicitly unresolved.
