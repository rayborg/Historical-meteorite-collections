...
- Schema 13 contains 19,638 facts-only records across 53 catalogs.
- Reviewed display projections replace 3,407 parents with 8,410 atomic cards: 24,641 descriptors comprise 14,234 specimens and 10,407 observations; weighted-only display excludes 172 unknown-mass specimens.
...
- Metadata covers 1,735 catalog-scoped source pages; records cite 1,558 of them.
...
- Blocked folio catalogs are: `anderson-1913` (0 pages, `undetermined`); `antarctic-1980` (0 pages, `undetermined`); `astapovich-1938` (0 pages, `undetermined`); `asu-2024-09` (0 pages, `undetermined`); `ball-1882` (0 pages, `undetermined`); `barnes-1940` (0 pages, `undetermined`); `berlin-1903` (0 pages, `undetermined`); `berlin-1904` (0 pages, `undetermined`); `brauns-bonn-1926` (0 pages, `undetermined`); `brown-1916` (0 pages, `undetermined`); `buchner-1863` (0 pages, `undetermined`); `chladni-1825` (0 pages, `undetermined`); `farrington-1903` (0 pages, `undetermined`); `farrington-1916` (0 pages, `undetermined`); `fletcher-1886` (0 pages, `undetermined`); `fletcher-1894` (0 pages, `undetermined`); `fletcher-1896` (0 pages, `undetermined`); `fletcher-1904` (0 pages, `undetermined`); `fletcher-1908` (0 pages, `undetermined`); `foote-1909` (0 pages, `undetermined`); `foote-1912` (0 pages, `undetermined`); `greifswald-1895` (0 pages, `undetermined`); `greifswald-1901` (0 pages, `undetermined`); `hamburg-1913` (0 pages, `undetermined`); `hodge-smith-1939` (0 pages, `undetermined`); `hogbom-1902` (0 pages, `undetermined`); `huss-1976` (0 pages, `undetermined`); `huss-1986` (0 pages, `undetermined`); `kanagawa-1996` (0 pages, `undetermined`); `kantor-1920` (0 pages, `undetermined`); `madrid-1923` (0 pages, `undetermined`); `mason-1964` (0 pages, `undetermined`); `merrill-1916` (0 pages, `undetermined`); `minnesota-1892` (0 pages, `undetermined`); `nininger-1950` (0 pages, `undetermined`); `nordenskiold-1870` (0 pages, `undetermined`); `palache-1926` (0 pages, `undetermined`); `prior-1923` (0 pages, `undetermined`); `prior-guide-1926` (0 pages, `undetermined`); `reeds-1937` (0 pages, `undetermined`); `schreiter-1912` (0 pages, `undetermined`); `story-maskelyne-1872` (0 pages, `undetermined`); `tassin-1902` (0 pages, `undetermined`); `usnm-1886` (0 pages, `undetermined`); `victoria-land-1982` (0 pages, `undetermined`); `ward-1881` (0 pages, `undetermined`); `ward-1904` (0 pages, `undetermined`); `washington-1897` (0 pages, `undetermined`).
- Reviewed MetBull harmonization covers 14,946 of 19,638 records: 14,606 resolved and 340 explicitly unresolved.
...
- The schema-1 current MetBull specimen-context sidecar is SHA-256 `75e9818c98bc045402ceee8bd603e2c8346daf7e5338729a98d2d0fa35e7447e`. Its exhaustive 14,234-card assignment maps 11,859 cards from 7,736 parents to 2,548 Official codes and leaves 2,375 cards unmapped. The direct partition is 5,653 mapped/171 unmapped; the projected partition is 6,206 mapped/2,204 unmapped.
...
- Every one of the 24,641 card identifiers starts with its concise catalog shortname. The 13,525 typed source identifiers retain their wording, 5,058 projected cards append `Catalog no.`, and 6,058 cards use the shortname alone. Projected cards divide into 241 typed, 5,058 numbered, and 3,111 shortname-only identifiers; direct cards contain 5,786 typed and 38 shortname-only identifiers. Internal entry order is never used as a fallback.
- The harmonized presenter derives 24,641 cards from 19,638 parent observations: 5,824 direct specimens, 8,410 projected atomic specimens, 6,867 collection observations, 3,447 collection-representation observations, 84 regional observations, 6 dealer observations, and 3 not-individual source observations. The 14,234 specimen cards preserve source-specific specimen fields while mapped cards add the linked Official heading and ordered current event context described below. Story and Prior context cards preserve representation facts without specimen claims.
- The unchecked default is strict: it shows 14,062 source-listed specimen cards, partitioned as 14,051 numeric and 11 qualitative; it excludes all 10,407 observations and 172 source-unlisted specimen cards. The inclusive 24,641-card state is explicit and uses `weighted=0`; omitted, malformed, duplicate, and legacy `weighted=1` states remain strict.
...
1. Preserve the current 53-catalog facts-only public release candidate. Commit or push only when explicitly requested.
...
3. Select the next processable bibliography control only after preserving and validating the current 53-catalog release candidate.
...
5. Keep schema 13 validation, deterministic private/public equality, release summaries, lineage checks, folio hashes, Node tests, runtime checks, and the facts-only privacy boundary green for every future release.
