...
- Schema 6 contains 2,323 facts-only records across 8 catalogs.
...
- Metadata covers 166 catalog-scoped source pages; records cite 149 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 411 records; its metadata source pages span 26-43, and its record citations span 26-43.
...
- Reviewed MetBull harmonization covers 2,323 of 2,323 records: 2,230 resolved and 93 explicitly unresolved.
