...
- Schema 6 contains 3,508 facts-only records across 8 catalogs.
...
- Metadata covers 223 catalog-scoped source pages; records cite 206 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,596 records; its metadata source pages span 26-100, and its record citations span 26-100.
...
- Reviewed MetBull harmonization covers 3,508 of 3,508 records: 3,387 resolved and 121 explicitly unresolved.
