...
- Schema 6 contains 3,242 facts-only records across 8 catalogs.
...
- Metadata covers 208 catalog-scoped source pages; records cite 191 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,330 records; its metadata source pages span 26-85, and its record citations span 26-85.
...
- Reviewed MetBull harmonization covers 3,242 of 3,242 records: 3,131 resolved and 111 explicitly unresolved.
