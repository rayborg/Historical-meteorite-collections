...
- Schema 6 contains 2,314 facts-only records across 8 catalogs.
...
- Metadata covers 165 catalog-scoped source pages; records cite 148 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 402 records; its metadata source pages span 26-42, and its record citations span 26-42.
...
- Reviewed MetBull harmonization covers 2,314 of 2,314 records: 2,221 resolved and 93 explicitly unresolved.
