...
- Schema 6 contains 3,521 facts-only records across 8 catalogs.
...
- Metadata covers 224 catalog-scoped source pages; records cite 207 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,609 records; its metadata source pages span 26-101, and its record citations span 26-101.
...
- Reviewed MetBull harmonization covers 3,521 of 3,521 records: 3,400 resolved and 121 explicitly unresolved.
