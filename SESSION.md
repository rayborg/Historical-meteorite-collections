...
- Schema 6 contains 2,334 facts-only records across 8 catalogs.
...
- Metadata covers 167 catalog-scoped source pages; records cite 150 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 422 records; its metadata source pages span 26-44, and its record citations span 26-44.
...
- Reviewed MetBull harmonization covers 2,334 of 2,334 records: 2,239 resolved and 95 explicitly unresolved.
