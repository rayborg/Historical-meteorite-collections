...
- Schema 6 contains 3,494 facts-only records across 8 catalogs.
...
- Metadata covers 222 catalog-scoped source pages; records cite 205 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,582 records; its metadata source pages span 26-99, and its record citations span 26-99.
...
- Reviewed MetBull harmonization covers 3,494 of 3,494 records: 3,373 resolved and 121 explicitly unresolved.
