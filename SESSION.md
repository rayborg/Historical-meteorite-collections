...
- Schema 6 contains 2,345 facts-only records across 8 catalogs.
...
- Metadata covers 168 catalog-scoped source pages; records cite 151 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 433 records; its metadata source pages span 26-45, and its record citations span 26-45.
...
- Reviewed MetBull harmonization covers 2,345 of 2,345 records: 2,250 resolved and 95 explicitly unresolved.
