...
- Schema 6 contains 2,146 facts-only records across 8 catalogs.
...
- Metadata covers 161 catalog-scoped source pages; records cite 144 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 234 records; its metadata source pages span 26-38, and its record citations span 26-38.
...
- Reviewed MetBull harmonization covers 2,146 of 2,146 records: 2,053 resolved and 93 explicitly unresolved.
