...
- Schema 6 contains 2,380 facts-only records across 8 catalogs.
...
- Metadata covers 171 catalog-scoped source pages; records cite 154 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 468 records; its metadata source pages span 26-48, and its record citations span 26-48.
...
- Reviewed MetBull harmonization covers 2,380 of 2,380 records: 2,285 resolved and 95 explicitly unresolved.
