...
- Schema 6 contains 2,478 facts-only records across 8 catalogs.
...
- Metadata covers 176 catalog-scoped source pages; records cite 159 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 566 records; its metadata source pages span 26-53, and its record citations span 26-53.
...
- Reviewed MetBull harmonization covers 2,478 of 2,478 records: 2,382 resolved and 96 explicitly unresolved.
