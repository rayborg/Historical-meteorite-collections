...
- Schema 6 contains 2,391 facts-only records across 8 catalogs.
...
- Metadata covers 172 catalog-scoped source pages; records cite 155 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 479 records; its metadata source pages span 26-49, and its record citations span 26-49.
...
- Reviewed MetBull harmonization covers 2,391 of 2,391 records: 2,295 resolved and 96 explicitly unresolved.
