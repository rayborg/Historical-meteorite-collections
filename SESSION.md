...
- Schema 6 contains 2,120 facts-only records across 8 catalogs.
...
- Metadata covers 159 catalog-scoped source pages; records cite 142 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 208 records; its metadata source pages span 26-36, and its record citations span 26-36.
...
- Reviewed MetBull harmonization covers 2,120 of 2,120 records: 2,027 resolved and 93 explicitly unresolved.
