...
- Schema 6 contains 3,110 facts-only records across 8 catalogs.
...
- Metadata covers 206 catalog-scoped source pages; records cite 189 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,198 records; its metadata source pages span 26-83, and its record citations span 26-83.
...
- Reviewed MetBull harmonization covers 3,110 of 3,110 records: 2,999 resolved and 111 explicitly unresolved.
