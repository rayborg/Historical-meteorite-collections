...
- Schema 6 contains 3,176 facts-only records across 8 catalogs.
...
- Metadata covers 207 catalog-scoped source pages; records cite 190 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,264 records; its metadata source pages span 26-84, and its record citations span 26-84.
...
- Reviewed MetBull harmonization covers 3,176 of 3,176 records: 3,065 resolved and 111 explicitly unresolved.
