...
- Schema 6 contains 2,079 facts-only records across 8 catalogs.
...
- Metadata covers 158 catalog-scoped source pages; records cite 141 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 167 records; its metadata source pages span 26-35, and its record citations span 26-35.
...
- Reviewed MetBull harmonization covers 2,079 of 2,079 records: 1,986 resolved and 93 explicitly unresolved.
