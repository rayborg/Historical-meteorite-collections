...
- Schema 6 contains 1,949 facts-only records across eight catalogs:
  ...
  - Nininger 1950: 37 `specimen` records from printed pages 26-28, with four Adrian rows continuing page-26 context on page 27; page 28's 1949 Albin stone is distinct from the 1915 pallasite, and Apoala is complete before Appley Bridge begins page 29.
- Metadata covers 151 source pages; records cite 134 of them.
...
- The runtime suite passes 108 tests. The validator passes all 1,949 records, eight catalogs, and 41 public display pages.
