...
- Schema 6 contains 2,937 facts-only records across 8 catalogs.
...
- Metadata covers 199 catalog-scoped source pages; records cite 182 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,025 records; its metadata source pages span 26-76, and its record citations span 26-76.
...
- Reviewed MetBull harmonization covers 2,937 of 2,937 records: 2,833 resolved and 104 explicitly unresolved.
