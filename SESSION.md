...
- Schema 6 contains 2,920 facts-only records across 8 catalogs.
...
- Metadata covers 198 catalog-scoped source pages; records cite 181 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,008 records; its metadata source pages span 26-75, and its record citations span 26-75.
...
- Reviewed MetBull harmonization covers 2,920 of 2,920 records: 2,816 resolved and 104 explicitly unresolved.
