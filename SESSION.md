...
- Schema 6 contains 3,436 facts-only records across 8 catalogs.
...
- Metadata covers 218 catalog-scoped source pages; records cite 201 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,524 records; its metadata source pages span 26-95, and its record citations span 26-95.
...
- Reviewed MetBull harmonization covers 3,436 of 3,436 records: 3,320 resolved and 116 explicitly unresolved.
