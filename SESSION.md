...
- Schema 6 contains 2,491 facts-only records across 8 catalogs.
...
- Metadata covers 177 catalog-scoped source pages; records cite 160 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 579 records; its metadata source pages span 26-54, and its record citations span 26-54.
...
- Reviewed MetBull harmonization covers 2,491 of 2,491 records: 2,395 resolved and 96 explicitly unresolved.
