...
- Schema 6 contains 3,070 facts-only records across 8 catalogs.
...
- Metadata covers 205 catalog-scoped source pages; records cite 188 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,158 records; its metadata source pages span 26-82, and its record citations span 26-82.
...
- Reviewed MetBull harmonization covers 3,070 of 3,070 records: 2,959 resolved and 111 explicitly unresolved.
