...
- Schema 6 contains 2,132 facts-only records across 8 catalogs.
...
- Metadata covers 160 catalog-scoped source pages; records cite 143 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 220 records; its metadata source pages span 26-37, and its record citations span 26-37.
...
- Reviewed MetBull harmonization covers 2,132 of 2,132 records: 2,039 resolved and 93 explicitly unresolved.
