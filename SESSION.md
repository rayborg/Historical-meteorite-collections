...
- Schema 6 contains 2,874 facts-only records across 8 catalogs.
...
- Metadata covers 194 catalog-scoped source pages; records cite 177 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 962 records; its metadata source pages span 26-71, and its record citations span 26-71.
...
- Reviewed MetBull harmonization covers 2,874 of 2,874 records: 2,770 resolved and 104 explicitly unresolved.
