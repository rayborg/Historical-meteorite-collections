...
- Schema 6 contains 3,473 facts-only records across 8 catalogs.
...
- Metadata covers 221 catalog-scoped source pages; records cite 204 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,561 records; its metadata source pages span 26-98, and its record citations span 26-98.
...
- Reviewed MetBull harmonization covers 3,473 of 3,473 records: 3,357 resolved and 116 explicitly unresolved.
