...
- Schema 6 contains 3,308 facts-only records across 8 catalogs.
...
- Metadata covers 209 catalog-scoped source pages; records cite 192 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,396 records; its metadata source pages span 26-86, and its record citations span 26-86.
...
- Reviewed MetBull harmonization covers 3,308 of 3,308 records: 3,197 resolved and 111 explicitly unresolved.
