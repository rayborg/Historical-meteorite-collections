...
- Schema 6 contains 2,861 facts-only records across 8 catalogs.
...
- Metadata covers 193 catalog-scoped source pages; records cite 176 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 949 records; its metadata source pages span 26-70, and its record citations span 26-70.
...
- Reviewed MetBull harmonization covers 2,861 of 2,861 records: 2,757 resolved and 104 explicitly unresolved.
