...
- Schema 6 contains 3,052 facts-only records across 8 catalogs.
...
- Metadata covers 204 catalog-scoped source pages; records cite 187 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,140 records; its metadata source pages span 26-81, and its record citations span 26-81.
...
- Reviewed MetBull harmonization covers 3,052 of 3,052 records: 2,942 resolved and 110 explicitly unresolved.
