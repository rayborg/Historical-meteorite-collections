...
- Schema 6 contains 3,326 facts-only records across 8 catalogs.
...
- Metadata covers 210 catalog-scoped source pages; records cite 193 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,414 records; its metadata source pages span 26-87, and its record citations span 26-87.
...
- Reviewed MetBull harmonization covers 3,326 of 3,326 records: 3,215 resolved and 111 explicitly unresolved.
