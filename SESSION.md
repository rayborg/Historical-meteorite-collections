...
- Schema 6 contains 2,964 facts-only records across 8 catalogs.
...
- Metadata covers 200 catalog-scoped source pages; records cite 183 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,052 records; its metadata source pages span 26-77, and its record citations span 26-77.
...
- Reviewed MetBull harmonization covers 2,964 of 2,964 records: 2,858 resolved and 106 explicitly unresolved.
