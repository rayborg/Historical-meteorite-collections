...
- Schema 6 contains 2,653 facts-only records across 8 catalogs.
...
- Metadata covers 182 catalog-scoped source pages; records cite 165 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 741 records; its metadata source pages span 26-59, and its record citations span 26-59.
...
- Reviewed MetBull harmonization covers 2,653 of 2,653 records: 2,556 resolved and 97 explicitly unresolved.
