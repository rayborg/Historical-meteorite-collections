...
- Schema 6 contains 2,801 facts-only records across 8 catalogs.
...
- Metadata covers 188 catalog-scoped source pages; records cite 171 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 889 records; its metadata source pages span 26-65, and its record citations span 26-65.
...
- Reviewed MetBull harmonization covers 2,801 of 2,801 records: 2,701 resolved and 100 explicitly unresolved.
