...
- Schema 6 contains 2,975 facts-only records across 8 catalogs.
...
- Metadata covers 201 catalog-scoped source pages; records cite 184 of them.
- Nininger coverage is derived without page-boundary assumptions: `nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,063 records; its metadata source pages span 26-78, and its record citations span 26-78.
...
- Reviewed MetBull harmonization covers 2,975 of 2,975 records: 2,867 resolved and 108 explicitly unresolved.
