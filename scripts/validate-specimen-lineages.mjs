...
const reviewUrl = args[2] ? pathToFileURL(args[2]) : new URL("../data/specimen-comparison-reviews.json", import.meta.url);
...
console.log(`validated ${result.relationshipCount} specimen-lineage relationships (${result.sameInventoryRelationshipCount} same inventory), ${result.comparisonGroupCount} comparison groups, and ${result.comparisonCandidateCount} comparison candidates`);
