...
test("production manifest is deterministic and validates against the locked catalog", () => {
  ...
  assert.equal(createHash("sha256").update(projectionText).digest("hex"), "7ab4ca4fef524f94e68d977f3a8106dc3b7a29ba7112ffe491deff91964ab445");
});
...
test("unprojected sources remain unprojected and schema 12 retains specimen locations", () => {
  ...
  assert.equal(published.metadata.sourceRecordCount, 19553);
});
