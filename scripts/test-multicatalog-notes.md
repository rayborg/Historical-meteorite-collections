...
The default `node scripts/validate-public-catalog.mjs` command reads and passes the real schema-6 `data/catalog.json` and `data/folios.json`: 5,345 records across 17 catalogs with 49 displayable folio pages.
