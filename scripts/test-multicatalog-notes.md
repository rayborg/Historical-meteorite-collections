...
The default `node scripts/validate-public-catalog.mjs` command reads and passes the real schema-6 `data/catalog.json` and `data/folios.json`: 3,353 records across 8 catalogs with 41 displayable folio pages.
