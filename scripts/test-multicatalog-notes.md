...
The default `node scripts/validate-public-catalog.mjs` command reads and passes the real schema-6 `data/catalog.json` and `data/folios.json`: 9,050 records across 20 catalogs with 49 displayable folio pages.
