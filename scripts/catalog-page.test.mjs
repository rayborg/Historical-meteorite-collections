...
test("homepage and catalog page markup keep navigation and UI states accessible", async () => {
  ...
  assert.match(html, /catalogs\.js\?v=20260920-haag-2003-1/);
  assert.match(html, /app\.js\?v=20260920-haag-2003-1/);
  assert.match(html, /styles\.css\?v=20260920-haag-2003-1/);
