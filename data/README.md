...
The current public input produces 7,976 flattened mass observations and 3,627 inventory observations. It publishes 422 relationships: 195 same-inventory relationships and 227 possible cross-source matches. The same-inventory total comprises 2 Huss and 193 Nininger relationships; one duplicated key is identity-resolved and none are omitted as ambiguous. The 227 possible matches include 184 exact-mass and 43 near-mass candidates, all currently unreviewed and based on reviewed MetBull identity. ASU September 2024 participates in 8 possible matches but is not a registered edition series.
