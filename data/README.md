...
`catalog.json` is a schema-6 facts-only dataset containing 2,884 source observations from 8 historical meteorite catalogs. `folios.json` is a separate schema-2, deny-by-default display manifest with 41 reviewed page entries.
