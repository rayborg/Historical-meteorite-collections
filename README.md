...
This repository is a dependency-free, facts-only index of 2,920 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 1,008 | 50 | 50 |
| **Total** |  | **2,920** | **198** | **181** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,008 records; its metadata source pages span 26-75, and its record citations span 26-75.
...
The current release includes reviewed MetBull harmonization for 2,920 of 2,920 records: 2,816 have a resolved current identity and 104 remain explicitly unresolved. 7 records currently have a null `name` value.
