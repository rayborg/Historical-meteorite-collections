...
This repository is a dependency-free, facts-only index of 2,079 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 167 | 10 | 10 |
| **Total** |  | **2,079** | **158** | **141** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 167 records; its metadata source pages span 26-35, and its record citations span 26-35.
...
The current release includes reviewed MetBull harmonization for 2,079 of 2,079 records: 1,986 have a resolved current identity and 93 remain explicitly unresolved. 7 records currently have a null `name` value.
