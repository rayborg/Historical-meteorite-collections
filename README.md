...
This repository is a dependency-free, facts-only index of 2,505 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 593 | 30 | 30 |
| **Total** |  | **2,505** | **178** | **161** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 593 records; its metadata source pages span 26-55, and its record citations span 26-55.
...
The current release includes reviewed MetBull harmonization for 2,505 of 2,505 records: 2,408 have a resolved current identity and 97 remain explicitly unresolved. 7 records currently have a null `name` value.
