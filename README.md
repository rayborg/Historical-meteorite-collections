...
This repository is a dependency-free, facts-only index of 2,213 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 301 | 14 | 14 |
| **Total** |  | **2,213** | **162** | **145** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 301 records; its metadata source pages span 26-39, and its record citations span 26-39.
...
The current release includes reviewed MetBull harmonization for 2,213 of 2,213 records: 2,120 have a resolved current identity and 93 remain explicitly unresolved. 7 records currently have a null `name` value.
