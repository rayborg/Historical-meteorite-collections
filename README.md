...
This repository is a dependency-free, facts-only index of 2,622 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 710 | 33 | 33 |
| **Total** |  | **2,622** | **181** | **164** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 710 records; its metadata source pages span 26-58, and its record citations span 26-58.
...
The current release includes reviewed MetBull harmonization for 2,622 of 2,622 records: 2,525 have a resolved current identity and 97 remain explicitly unresolved. 7 records currently have a null `name` value.
