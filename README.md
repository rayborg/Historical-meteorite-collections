...
This repository is a dependency-free, facts-only index of 2,964 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 1,052 | 52 | 52 |
| **Total** |  | **2,964** | **200** | **183** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,052 records; its metadata source pages span 26-77, and its record citations span 26-77.
...
The current release includes reviewed MetBull harmonization for 2,964 of 2,964 records: 2,858 have a resolved current identity and 106 remain explicitly unresolved. 7 records currently have a null `name` value.
