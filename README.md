...
This repository is a dependency-free, facts-only index of 2,334 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 422 | 19 | 19 |
| **Total** |  | **2,334** | **167** | **150** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 422 records; its metadata source pages span 26-44, and its record citations span 26-44.
...
The current release includes reviewed MetBull harmonization for 2,334 of 2,334 records: 2,239 have a resolved current identity and 95 remain explicitly unresolved. 7 records currently have a null `name` value.
