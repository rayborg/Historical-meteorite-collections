...
This repository is a dependency-free, facts-only index of 3,176 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 1,264 | 59 | 59 |
| **Total** |  | **3,176** | **207** | **190** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,264 records; its metadata source pages span 26-84, and its record citations span 26-84.
...
The current release includes reviewed MetBull harmonization for 3,176 of 3,176 records: 3,065 have a resolved current identity and 111 remain explicitly unresolved. 7 records currently have a null `name` value.
