...
This repository is a dependency-free, facts-only index of 2,120 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 208 | 11 | 11 |
| **Total** |  | **2,120** | **159** | **142** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 208 records; its metadata source pages span 26-36, and its record citations span 26-36.
...
The current release includes reviewed MetBull harmonization for 2,120 of 2,120 records: 2,027 have a resolved current identity and 93 remain explicitly unresolved. 7 records currently have a null `name` value.
