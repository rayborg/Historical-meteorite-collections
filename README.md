...
This public facts-only release was generated from accepted private source commit `6629a61`.
...
Anderson 1913 contributes 57 facts-only collection entries citing pages 54-66, with 24 reviewed exact-name mappings and 33 pending observations. Kantor 1920 contributes 30 facts-only collection entries citing pages 107-122, with 12 reviewed exact-name mappings, 18 pending observations, and 34 numeric gram values. Astapovich 1938 contributes 90 facts-only collection entries citing pages 195-196, with 17 reviewed exact-name mappings and 73 pending observations. All three have blocked/undetermined zero-page folio policies and no public media.
...
The current release includes reviewed MetBull harmonization for 10,078 of 13,542 records: 9,949 have a resolved current identity and 129 remain explicitly unresolved. 13 records currently have a null `name` value.
