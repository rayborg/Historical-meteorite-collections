...
This repository is a dependency-free, facts-only index of 3,521 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 1,609 | 76 | 76 |
| **Total** |  | **3,521** | **224** | **207** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,609 records; its metadata source pages span 26-101, and its record citations span 26-101.
...
The current release includes reviewed MetBull harmonization for 3,521 of 3,521 records: 3,400 have a resolved current identity and 121 remain explicitly unresolved. 7 records currently have a null `name` value.
