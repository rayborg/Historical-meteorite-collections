...
This repository is a dependency-free, facts-only index of 2,824 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 912 | 42 | 42 |
| **Total** |  | **2,824** | **190** | **173** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 912 records; its metadata source pages span 26-67, and its record citations span 26-67.
...
The current release includes reviewed MetBull harmonization for 2,824 of 2,824 records: 2,724 have a resolved current identity and 100 remain explicitly unresolved. 7 records currently have a null `name` value.
