...
This repository is a dependency-free, facts-only index of 3,421 source observations from 8 historical meteorite catalogs. The coordinated catalog uses public metadata schema 6 and supports 4 source-specific record models: `catalog-item`, `catalog-number`, `collection-entry`, `specimen`.
...
| `nininger-1950` | `specimen` | 1,509 | 69 | 69 |
| **Total** |  | **3,421** | **217** | **200** |
...
`nininger-1933` has 136 records; its metadata source pages span 1-20, and its record citations span 1-11. `nininger-1950` has 1,509 records; its metadata source pages span 26-94, and its record citations span 26-94.
...
The current release includes reviewed MetBull harmonization for 3,421 of 3,421 records: 3,305 have a resolved current identity and 116 remain explicitly unresolved. 7 records currently have a null `name` value.
